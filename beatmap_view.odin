...
ais := []AIInfo {
     {
        ...
        replay_state = &automod_replay,
        color = {0, 1, 1, 1},
    },
     {
        name = "Automod Smoothed",
        ai_fn = cursor_strategy_lazy_position,
        replay_state = &custom_ai_replay,
        color = {1, 0, 0, 1},
    },
     {
...
AIInfo :: struct {
    ai_fn:        CursorMotionStragetgyProc,
...
reset_ai_replays :: proc() {
    for ai in ais {
        reset_ai_replay(ai.replay_state)
    }
}
